...
public class AppServiceImpl extends ServiceImpl<AppMapper, App>
    ...
    @Override
    public Flux<String> chatGenerateCode(AppChatRequest request) {
        App byId = this.getById(request.getId());
        ThrowUtils.throwIf(byId == null, ErrorCode.SYSTEM_ERROR, "该应用不存在");
        return aiCodeGeneratorFacade.generateAndSaveCode(request.getMessage(), CodeGenTypeEnum.getEnumByValue(request.getCodeType()), request.getId());
    }
