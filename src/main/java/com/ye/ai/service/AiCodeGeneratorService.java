...
public interface AiCodeGeneratorService {
    ...
    Flux<String> generateHtmlCode(@MemoryId Long appId, @UserMessage String userMessage);
    ...
    Flux<String> generateMultiFileCode(@MemoryId Long appId, @UserMessage String userMessage);
