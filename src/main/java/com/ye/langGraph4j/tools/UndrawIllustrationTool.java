package com.ye.langGraph4j.tools;
...
import com.ye.langGraph4j.model.enums.ImageCategoryEnum;
...
public class UndrawIllustrationTool {
    ...
    public List<ImageResource> searchIllustrations(@P("搜索关键词, 必须是英文") String query) {
