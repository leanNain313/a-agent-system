...
public class UserController {
    ...
    public BaseResponse<Object> userRegister(@RequestBody @Parameter RegisterRequest userRegisterRequest) {
    ...
    public BaseResponse<Object> userResetPassword(@RequestBody @Parameter RegisterRequest userRegisterRequest) {
        if (userRegisterRequest == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
